<template>
    <div :class="[darkMode ? 'dark-mode' : '', fontSize == 'small' ? 'small-mode' : '', fontSize == 'medium' ? 'medium-mode' : '', fontSize == 'large' ? 'large-mode' : '']">
                    <main>
                        <div class="container">
                                ...
                                <div class="col-lg-7">
                                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                                        <div class="card-header">
                                            <h3 class="text-center font-weight-light my-4">App Setting</h3>
                                        </div>
                                        <div class="card-body">
                                            <form @submit.prevent="update">
                                                ...
                                                <div class="form-floating mb-3">
                                                    <input v-model="localId" class="form-control" id="inputID"
                                            ...
                                            <div class="mt-4 mb-0">
                                                ...
                                                <button @click="fontSet($event)" value="small"
                                                    class="btn btn-outline-primary btn-sm" id="fontBtn-sm" style="background-color: white;">작게</button>
                                                &nbsp;
                                                <button @click="fontSet($event)" value="medium"
                                                    class="btn btn-outline-primary" id="fontBtn-md">중간</button> &nbsp;
                                                <button @click="fontSet($event)" value="large"
                                                    class="btn btn-outline-primary btn-lg" id="fontBtn-lg">크게</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
